<div class="relative wave-bg bg-background-footer pb-8 text-white">
    <div class="container mx-auto px-5 md:px-12">
        ...
        <div class="flex flex-col gap-8 md:flex-row md:gap-4 justify-between items-center mb-12 xl:mb-20">
            <h1 class="text-3xl lg:text-5xl font-extrabold text-center md:text-left">
                Be part of <br />
            ...
            <div class="flex flex-col gap-4 w-full sm:w-80">
                ...
                <a href="http://blib.li/igx-2025" class="btn-primary text-center font-extrabold text-base xl:text-lg px-6 py-3 sm:px-12 sm:py-4 rounded-lg uppercase">Get Ticket</a>
            </div>
        </div>
