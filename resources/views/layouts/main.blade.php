...
<html data-theme="true" data-theme-mode="light" lang="en">
    <head>
        ...
        <meta property="og:description" content="{{ @$description ?? env('APP_DESCRIPTION', 'Indonesia Game Expo - The Ultimate Gaming Event in Indonesia') }}">
        ...
        <meta name="twitter:description" content="{{ @$description ?? env('APP_DESCRIPTION', 'Indonesia Game Expo - The Ultimate Gaming Event in Indonesia') }}">
