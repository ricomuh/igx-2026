<section class="container px-5 mx-auto lg:px-12 xl:px-20 py-20 text-white">
  <div class="flex flex-col items-center text-center justify-center gap-4 mb-10">
    ...
    <h2 class="text-2xl md:text-3xl lg:text-4xl">PLAY THE <span class="text-secondary">IGX FUSION CELEBRATION,</span>
